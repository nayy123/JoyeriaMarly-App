    ...
    <footer className="w-full bg-white border-t border-gray-200 font-serif">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm text-[#2C3E5E]">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="/our-story" className="hover:text-[#040F2E]">Our Story</a></li>
        ...
        <div>
          ...
          <p className="mb-2">
            <strong>Order status, delivery issues:</strong><br />
            <a href="mailto:contactmarly@gmail.com" className="hover:text-[#040F2E]">
              contactmarly@gmail.com
            </a><br />
            Mon – Fri (10 AM – 6 PM)
          </p>
          <p>
            <strong>Exchange & Replacement:</strong><br />
            <a href="/exchange" className="hover:text-[#040F2E]">Book your exchange here</a><br />
