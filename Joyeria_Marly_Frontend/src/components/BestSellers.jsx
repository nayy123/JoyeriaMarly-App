...
const BestSellers = () => {
  ...
  useEffect(() => {
    const loadHeaderImage = async () => {
      try {
        const response = await fetch(`${API_BASE_URL}/best-sellers-header-image`);
        if (response.ok) {
    ...
    const sampleProducts = [
      {
        ...
        material: "Gold",
        type: "Ring",
        descripcion: "Elegant gold ring with premium finish",
      ...
      },
      {
        ...
        material: "Silver",
        type: "Bracelet",
        descripcion: "Beautiful silver bracelet with charm details",
        imagenUrl: "/images/silver-bracelet.jpg",
        stock: 12
      },
      {
        id: 3,
        name: "Diamond Classic Necklace",
        price: 199.99,
        material: "Gold",
        type: "Necklace",
        descripcion: "Classic diamond necklace for special occasions",
        imagenUrl: "/images/diamond-necklace.jpg",
        stock: 5
      },
      {
        id: 4,
        ...
        material: "Pearl",
        type: "Earrings",
        descripcion: "Elegant pearl drop earrings",
        imagenUrl: "/images/pearl-earrings.jpg",
        stock: 15
      },
  ...
  const handleImageChange = async (e) => {
    ...
    if (file && currentUser.rol === 1) {
      ...
      try {
        const response = await fetch(`${API_BASE_URL}/upload-best-sellers-header-image`, {
          method: 'POST',
          body: formData,
        });
            ...
            <div className="hero-image-container">
              {headerImage ? (
                ...
                <div className="hero-placeholder">
                  ...
                  <p className="text-white mt-2">Our most popular jewelry pieces</p>
                  {backendError && (
