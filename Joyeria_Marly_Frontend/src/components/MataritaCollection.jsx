...
const MataritaCollection = () => {
  ...
  useEffect(() => {
    const loadHeaderImage = async () => {
      try {
        const response = await fetch(`${API_BASE_URL}/matarita-collection-header-image`);
        if (response.ok) {
    ...
    const sampleProducts = [
      {
        ...
        material: "Gold",
        type: "Ring",
        descripcion: "Vibrant gemstone ring with tropical inspiration",
      ...
      },
      {
        ...
        material: "Silver",
        type: "Necklace",
        descripcion: "Crystal necklace capturing sunset colors",
        imagenUrl: "/images/sunset-necklace.jpg",
        stock: 8
      },
      {
        id: 3,
        name: "Palm Tree Earrings",
        price: 75.25,
        material: "Gold",
        type: "Earrings",
        descripcion: "Elegant earrings with palm tree motif",
        imagenUrl: "/images/palm-earrings.jpg",
        stock: 12
      },
      {
        id: 4,
        name: "Beach Wave Anklet",
        price: 55.00,
        material: "Silver",
        type: "Anklet",
        descripcion: "Delicate anklet with beach wave design",
        imagenUrl: "/images/wave-anklet.jpg",
        stock: 18
      },
  ...
  const handleImageChange = async (e) => {
    ...
    if (file && currentUser.rol === 1) {
      ...
      try {
        const response = await fetch(`${API_BASE_URL}/upload-matarita-collection-header-image`, {
          method: 'POST',
          body: formData,
        });
            ...
            <div className="hero-image-container">
              {headerImage ? (
                ...
                <div className="hero-placeholder">
                  <h2 className="text-3xl font-bold text-white">MATARITA COLLECTION</h2>
                  <p className="text-white mt-2">Tropical inspired jewelry pieces</p>
                  {backendError && (
